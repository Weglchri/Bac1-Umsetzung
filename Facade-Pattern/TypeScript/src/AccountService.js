...
var AccountService = /** @class */ (function () {
    function AccountService() {
        ...
        this.datacheck = new DataCheck_1.DataCheck();
    }
    AccountService.prototype.checkPersonInsuranceClaim = function (person) {
        return __awaiter(this, void 0, void 0, function () {
            var permission, permission_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        permission = false;
                        if (!(this.validator.validatePersonData(person) === true)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.datacheck.checkInsurance(person)];
                    case 1:
                        permission_1 = _a.sent();
                        this.logger.printMessage("Person permission: " + permission_1);
                        return [2 /*return*/, permission_1];
                    case 2:
